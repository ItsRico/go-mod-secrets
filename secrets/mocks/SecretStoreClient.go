...
// ConfigureConsulAccess provides a mock function with given fields: secretStoreToken, bootstrapACLToken, registryHost, registryPort
func (_m *SecretStoreClient) ConfigureConsulAccess(secretStoreToken string, bootstrapACLToken string, registryHost string, registryPort int) error {
	ret := _m.Called(secretStoreToken, bootstrapACLToken, registryHost, registryPort)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, string, int) error); ok {
		r0 = rf(secretStoreToken, bootstrapACLToken, registryHost, registryPort)
	} else {
		r0 = ret.Error(0)
	}
...
// CreateRole provides a mock function with given fields: secretStoreToken, registryRole
func (_m *SecretStoreClient) CreateRole(secretStoreToken string, registryRole types.RegistryRole) error {
	ret := _m.Called(secretStoreToken, registryRole)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, types.RegistryRole) error); ok {
		r0 = rf(secretStoreToken, registryRole)
	} else {
		r0 = ret.Error(0)
	}
